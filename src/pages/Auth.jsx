  ...
  <div className="auth-right">
    <div className="auth-card">
      <div className="auth-tabs">
        <button className="auth-tab active" id="tab-login" onClick={(e) => { switchTab('login') }}>Log In</button>
        <button className="auth-tab" id="tab-signup" onClick={(e) => { switchTab('signup') }}>Create Account</button>
      </div>
      ...
      <div id="login-section">
        ...
        <button className="btn-auth-google" onClick={(e) => { googleLogin() }}>
        ...
        <button className="btn-auth-google" style={{marginTop: '12px', color: 'var(--navy)'}} onClick={(e) => { switchTab('phone') }}>
          📱 Continue with Phone
        </button>
        <div className="auth-footer-text">Don't have an account? <button onClick={(e) => { switchTab('signup') }}>Sign up free →</button></div>
      </div>
      ...
      <div id="signup-section" style={{display: 'none'}}>
        ...
        <div className="auth-step active" id="su-step-1">
          ...
          <form id="su-form-1" onsubmit="suStep1(event)" novalidate>
            <div className="form-group">
          ...
          <div className="auth-footer-text">Already have an account? <button onClick={(e) => { switchTab('login') }}>Log in</button></div>
        </div>
        ...
        <div className="auth-step" id="su-step-2">
          ...
          <form id="su-form-2" onsubmit="suFinish(event)" novalidate>
            <div className="form-group">
              <label className="form-label">Create Password *</label>
              <div className="input-wrap">
                <input className="form-input" id="su-password" type="password" placeholder="At least 8 characters" autocomplete="new-password" onInput={(e) => { checkPwStrength(this.value) }}/>
            ...
            <div className="form-group">
              ...
              <div className="input-wrap">
                ...
                <button type="button" className="pw-toggle" onClick={(e) => { togglePw('su-password2',this) }}>👁</button>
              </div>
          ...
          <div className="auth-footer-text"><button onClick={(e) => { suGoTo(1) }}>← Back</button></div>
        </div>
      </div>
      ...
      <div id="forgot-section" style={{display: 'none'}}>
        ...
        <form id="forgot-form" onsubmit="submitForgot(event)" novalidate>
          <div className="form-group">
            <label className="form-label">Email Address</label>
      ...
      <div id="phone-section" style={{display: 'none'}}>
        ...
        <form id="phone-form" onsubmit="submitPhoneAuth(event)" novalidate>
          <div className="form-group">
            <label className="form-label">Phone Number</label>
            <div className="phone-wrap">
              <div className="phone-prefix">🇮🇳 +91</div>
        ...
        <div className="auth-footer-text" style={{marginTop: '20px'}}><button onClick={(e) => { switchTab('login') }}>← Back to login options</button></div>
      </div>
      ...
      <div id="otp-section" style={{display: 'none'}}>
        ...
        <form id="otp-form" onsubmit="verifyOTP(event)" novalidate>
          <div className="form-group">
        ...
        <div className="auth-footer-text" style={{marginTop: '20px'}}><button onClick={(e) => { switchTab('phone') }}>← Change phone number</button></div>
      </div>
