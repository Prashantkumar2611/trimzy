...
def convert_file(html_file, jsx_file, comp_name, script_name, css_name):
    ...
    def onclick_replacer(match):
        ...
        funcs = [
            'goBack', 'openBookingModal', 'closeBookingModal', 'goToStep',
            'selectTime', 'confirmBooking', 'loginToBook'
        ]
        for func in funcs:
...
convert_file('barber-profile.html', 'BarberProfile.jsx', 'BarberProfile', 'barber-profile.js', 'barber-profile.css')
